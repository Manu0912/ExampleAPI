...
namespace ExampleTests
{
    public class UnitTest1
    {
        ...
        {
            var result = _validator.TestValidate(new ExampleItem() { Id = 1, Name = "sjdfbdskj", IsComplete = true });
        ...
        {
            var result = _validator.TestValidate(new ExampleItem() { Id = 1, Name = "sjdfbdskjsjdfbdskjsjdfbdskjsjdfbdskjsjdfbdskjsjdfbdskjsjdfbdskjsjdfbdskjsjdfbdskjsjdfbdskjsjdfbdskjsjdfbdskjsjdfbdskj", IsComplete = true });
